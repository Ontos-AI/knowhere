"""Knowhere-native hierarchy provider leftovers for MAP-NAV.

Publication types and the eager ``KnowhereProvider`` live in
``shared.services.retrieval.scoring``. This module keeps the episode-local
lazy/DB loaders used by map-nav snapshot loading.
"""
...
from shared.services.retrieval.nav.nav_address import NavLevel
